    ...
    return (
        ...
        <section className='ContactSection'>
            ...
            <div className='p-e-g-l'>
                <div className = 'Phone'>
                    <h3> Phone Number: <a href='tel:832-403-0406'>(832)-403-0406</a> </h3>
                </div>
                <div className = 'Email'>
                    <h3>Email: <a href='mailto://gamefndr@gmail.com'>gamefndr@gmail.com</a></h3>
                </div>
                <div className ='GitHub'>
                    <h3>Git Hub: <a href='https://github.com/jacobduden'> Jacob Duden</a><br/>
                ...
                <div className='LinkedIn'>
                    <h3>LinkedIn: <a href='https://www.linkedin.com/in/jacob-duden-93951a137/'> Jacob Duden </a><br/>
