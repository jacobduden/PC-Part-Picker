...
export default function ResultsAction(data){
    const image="https://logos-world.net/wp-content/uploads/2021/02/Call-of-Duty-Logo.png";
            ...
            <Container fluid className="games-cont">
                <Container className="games-cont2">
                    ...
                    <Row className="games-card-row" style={{ justifyContent: "center", paddingBottom: "10px" }}>
                        <ResultCard gameName={data[0].name} img={image} tag="action"/>
                        <ResultCard gameName={data[1].name} img={image} tag="action"/>
                        <ResultCard gameName={data[2].name} img={image} tag="action"/>
                        <ResultCard gameName={data[3].name} img={image} tag="action"/>
                        <ResultCard gameName={data[4].name} img={image} tag="action"/>
                        <ResultCard gameName={data[5].name} img={image} tag="action"/>
